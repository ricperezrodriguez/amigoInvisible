...
@Component({
  ...
  templateUrl: './asociarFriends.component.html',
  styleUrl: './asociarFriends.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AsociarFriendsComponent implements OnInit {
  personas = ['chandler', 'joey', 'monica', 'phoebe', 'rachel', 'ross'];
  cosas = ['patos', 'perro', 'pavo', 'guitarra', 'objrachel', 'mono'];
  arrTotal!: string[];
